...
likeButtons.forEach(button => {
    button.addEventListener('click', function() {
        ...
        const likedSongsTable = document.getElementById('liked-songs-table');
        ...
        if (this.classList.contains('liked')) {
            ...
            const index = rows.findIndex(tr => tr.textContent === songRow.textContent);
...
//end of liked feature

//NOW PLAYING STUFF//


// Get the buttons from the "Now Playing" tab
const nowPlayingPrevButton = document.querySelector('#nowplaying-tab .control-button#prev');
const nowPlayingPlayPauseButton = document.querySelector('#nowplaying-tab .control-button#play-pause');
const nowPlayingNextButton = document.querySelector('#nowplaying-tab .control-button#next');

// Get the buttons from the bottom play controller
const bottomPrevButton = document.querySelector('.player-button#prev');
const bottomPlayPauseButton = document.querySelector('.player-button#play');
const bottomNextButton = document.querySelector('.player-button#next');
...
nowPlayingPrevButton.addEventListener('click', () => bottomPrevButton.click());
nowPlayingPlayPauseButton.addEventListener('click', () => bottomPlayPauseButton.click());
nowPlayingNextButton.addEventListener('click', () => bottomNextButton.click());
